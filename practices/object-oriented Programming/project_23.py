...
- 5. Project 23: Library Management System
"""
# %% 1. What is Constructors?
# A constructor is a special method used to initialize objects.
# In Python, the constructor is defined by the underscore.
class Book:
...
# %% 3. Class Methods vs. Static Methods
# Class methods, which start with the @classmethod decorator, operate on the class itself rather than on individual instances.
# You don't need to pass an instance to them.
...
class Account:
  def __init__(self, owner, balance=0):
    self.owner = owner
    self.__balance = balance # __ is a private attribute
